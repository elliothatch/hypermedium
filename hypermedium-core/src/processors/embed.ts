// import { Hal, HypermediaEngine, ExtendedResource, Processor } from 'hypermedium';
...
//  */
// export const embed: Processor.Factory = () => ({
//     name: 'embed',
//     fn: (rs) => {
...
//             if(!Array.isArray(links) && embedded[embedRel].length === 1) {
